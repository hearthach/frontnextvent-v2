...
export const _addressBooks = [...Array(24)].map((_, index) => ({
  ...
  addressType: index === 0 ? 'Casa' : 'Oficina', // 'Home' : 'Office'
}));
...
export const _socials = [
  {
    ...
    color: '#1877F2',
    path: 'https://www.facebook.com/tiendazilexoficial',
  },
  {
    value: 'instagram',
    name: 'Instagram',
    ...
    color: '#E02D69',
    path: 'https://www.instagram.com/zilexbrand/',
  },
  {
    value: 'whatsapp',  // Agregamos WhatsApp
    name: 'WhatsApp',
